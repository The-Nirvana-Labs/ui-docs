<template>
  <Demonstration title="Bottom Navigation">
    <template #output>
      <Center>
  ...
  <Demonstration title="Bottom Navigation with brand colors">
    <template #output>
      <Center>
        <div class="flex flex-col w-full">
          <div class="btm-nav relative my-2">
  ...
  <Demonstration title="Bottom Navigation with state colors">
    <template #output>
      <Center>
        <div class="flex flex-col w-full">
          <div class="btm-nav relative">
  ...
  <Demonstration title="With title">
    <template #output>
      <Center>
        <div class="btm-nav relative">
          <button>
  ...
  <Demonstration title="With custom colors">
    <template #output>
      <Center>
        <div class="btm-nav relative">
